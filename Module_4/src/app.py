...
# This finds the 'src' folder where this file lives
base_path = os.path.dirname(os.path.abspath(__file__))
# This goes UP one level to 'Module_4', then finds the 'templates' folder
template_dir = os.path.abspath(os.path.join(base_path, '..', 'templates'))
...
def index():
    ...
    # Pre-filling data to avoid Jinja2 errors if DB is empty
    data = {
        "scraping_status": scraping_active,
        "q1": 0, "q2": 0, "avg_gpa": 0, "avg_gre": 0, 
        "avg_gre_v": 0, "avg_gre_aw": 0, "q4": 0, "q5": 0, 
        "q6": 0, "q7": 0, "q8": 0, "q9": 0, "q10": [], "q11": []
    }
